...
;;                       (Put the name of the testing program here.)
...
(define p2 (make-polynomial 'x '((50 1) (8 -2) (4 -1) (0 5))))
;Value: p2

(define p3 (make-polynomial 'x '((50 1) (6 3) (4 1) (0 7))))
;Value: p3

(define p10 (make-polynomial 'y '()))
;Value: p10

(define p11 (make-polynomial 'y '((100 1) (2 2) (0 1))))
;Value: p11

(add p0 p1)
;Value 18: (polynomial x (100 1) (2 2) (0 1))

(add p1 p2)
;Value 16: (polynomial x (100 1) (50 1) (8 -2) (4 -1) (2 2) (0 6))

(add p2 p3)
;Value 19: (polynomial x (50 2) (8 -2) (6 3) (0 12))

(mul p0 p1)
;Value 20: (polynomial x)

(mul p1 p2)
;Value 17: (polynomial x (150 1) (108 -2) (104 -1) (100 5) (52 2) (50 1) (10 -4) (8 -2) (6 -2) (4 -1) (2 10) (0 5))
