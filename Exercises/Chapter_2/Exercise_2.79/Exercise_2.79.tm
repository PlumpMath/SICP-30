...
<\body>
  <\render-exercise|Exercise 2.79>
    ...
    Define a generic equality predicate <scm|equ?> that tests the equality of
    ...
    <\answer>
      ...
      The generic equality predicate <scm|equ?> is defined as follow:

      <\scm-code>
        (define (equ? x y) (apply-generic 'equ? x y))
      </scm-code>

      <hspace|3ex>We begin by installing it into the package for handling
      ordinary numbers:
      ...
      <hspace|3ex>Here is the package which performs rational arithmetic
      after installing the <scm|equ?> predicate:
      ...
      into the package that handles complex numbers:<\footnote>
        ...
        be done by adding the <scm|equ?> predicate into both rectangular and
        polar packages:
