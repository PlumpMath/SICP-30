...
<\body>
  <\render-exercise|Exercise 2.29>
    ...
    <\answer>
      ...
      </float>. Thus, we can immediately write the selectors
      ...
      Similarly, the corresponding selectors <scm|branch-length> and
      <scm|branch-structure> can be expressed as:
      ...
      b. As an example shown in figure <reference|Exercise_2.29-Figure_2><\float|float|tbh>
        ...
        3>|<point|5.8|-2.3>>>>>|A example of mobile>
      ...
      Finally, to make the program robust, we'd better also take the empty
      ...
      Hence, these reveal the whole picture of <scm|total-weight><\footnote>
      ...
      d. Note that in designing this system to deal with the object mobile,
      we mainly used data abstraction to help us control its complexity. The
      abstraction barriers we established to isolate the operation on mobile
      with its underlying representation are the constructor and selectors:
      <scm|make-mobile>, <scm|left-branch> and <scm|right-branch>. Similar is
      the data object branch whose constructor and selectors are
      <scm|make-branch>, <scm|branch-length> and <scm|branch-structure>. Only
      these constructors and selectors know the underlying implementation of
      a mobile and a branch. We can envision the structure of mobile system
      as shown in figure <reference|Exercise_2.29-Figure_3><\float|float|tbh>
        <big-figure|<label|Exercise_2.29-Figure_3><with|gr-mode|<tuple|group-edit|group-ungroup>|gr-frame|<tuple|scale|1cm|<tuple|0.5gw|0.5gh>>|gr-geometry|<tuple|geometry|1par|0.6par>|gr-grid|<tuple|empty>|gr-grid-old|<tuple|cartesian|<point|0|0>|1>|gr-edit-grid-aspect|<tuple|<tuple|axes|none>|<tuple|1|none>|<tuple|10|none>>|gr-edit-grid|<tuple|empty>|gr-edit-grid-old|<tuple|cartesian|<point|0|0>|1>|gr-auto-crop|true|<graphics||<gr-group|<gr-group|<line|<point|-6.0|1.0>|<point|-3.61851766106628|0.99957666357984>>|<cline|<point|-3.60875|1.20272>|<point|3.57497023415796|1.20271861357322>|<point|3.57497023415796|0.79125545707104>|<point|-3.60875115756052|0.79125545707104>>|<text-at|<scm|make-branch>|<point|-3.5|0.9>>|<text-at|<scm|branch-length>|<point|-1.5|0.9>>|<text-at|<scm|branch-structure>|<point|0.8|0.9>>|<line|<point|3.55703|0.999577>|<point|6.0|1.0>>>|<gr-group|<line|<point|-3.17401|2.18492>|<point|-6.0|2.2>>|<cline|<point|3.15271719671914|2.46985025061486>|<point|3.15271719671914|1.98785858505064>|<point|-3.15569|1.96713163704164>|<point|-3.15569|2.46713163704164>>|<text-at|<scm|make-mobile>|<point|-2.95569|2.16713163704164>>|<text-at|<scm|left-branch>|<point|-0.95569|2.16713163704164>>|<text-at|<scm|right-branch>|<point|1.04431|2.16713163704164>>|<line|<point|3.15487|2.18492>|<point|6.0|2.2>>>|<gr-group|<line|<point|-2.02517|3.51843>|<point|-6.1|3.5>>|<cline|<point|-2.00876|3.82741>|<point|2.02638245799709|3.82740772588967>|<point|2.02638245799709|3.32954094456939>|<point|-2.00875777219209|3.32954094456939>>|<text-at|Programs
        that use mobiles|<point|-1.9|3.5>>|<line|<point|2.01769|3.51843>|<point|5.9|3.5>>>|<text-at|Branch
        as numbers or mobiles|<point|-2.2|0.3>>|<text-at|Mobiles in problem
        domain|<point|-2.0|2.8>>|<text-at|Mobiles as left branch and right
        branch |<point|-2.8|1.5>>>>>|Data-abstraction barriers in the mobile
        package>
      ...
      changes. Hence, the program needs only a minor adjustment:
...
<\auxiliary>
  <\collection>
    <\associate|figure>
      ...
      <tuple|normal|A example of mobile|<pageref|auto-2>>
