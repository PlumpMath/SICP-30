...
<\body>
  <\render-exercise|Exercise 2.71>
    ...
    <math|1,2,4,\<ldots\>,2<rsup|n-1>>. Sketch the tree for <math|n=5>; for
    <math|n=10>. In such a tree (for general <math|n>) how may bits are
    required to encode the most frequent symbol? the least frequent symbol?

    <\answer>
      \;

      Figure <reference|Exercise_2.71-Figure_1><\float|float|tbh>
        <big-figure|<label|Exercise_2.71-Figure_1><with|gr-mode|<tuple|group-edit|group-ungroup>|gr-frame|<tuple|scale|1cm|<tuple|0.5gw|0.5gh>>|gr-geometry|<tuple|geometry|1par|0.6par>|gr-grid|<tuple|empty>|gr-grid-old|<tuple|cartesian|<point|0|0>|1>|gr-edit-grid-aspect|<tuple|<tuple|axes|none>|<tuple|1|none>|<tuple|10|none>>|gr-edit-grid|<tuple|empty>|gr-edit-grid-old|<tuple|cartesian|<point|0|0>|1>|gr-arrow-end|o|gr-auto-crop|true|<graphics||<gr-group|<text-at|<math|<around*|(|S<rsub|1>
        16|)>>|<point|-5.4|0.6>>|<with|arrow-end|o|<line|<point|-3.0|1.5>|<point|-5.0|1.0>>>|<with|arrow-end|o|<line|<point|-3.0|1.5>|<point|-1.0|1.0>|<point|-2.5|0.5>>>|<text-at|<math|<around*|(|S<rsub|2>
        8|)>>|<point|-2.8|0.1>>|<with|arrow-end|o|<line|<point|-1.0|1.0>|<point|1.0|0.5>|<point|-0.5|8.32667268468867e-17>>>|<text-at|<math|<around*|{|<around*|(|S<rsub|1>
        S<rsub|2> S<rsub|3> S<rsub|4> S<rsub|5>|)>
        31|}>>|<point|-4.2|1.7>>|<text-at|<math|<around*|(|S<rsub|3>
        4|)>>|<point|-0.8|-0.4>>|<with|arrow-end|o|<line|<point|1.0|0.5>|<point|3.0|8.32667268468867e-17>|<point|2.0|-0.5>>>|<text-at|<math|<around*|{|<around*|(|S<rsub|2>
        S<rsub|3> S<rsub|4> S<rsub|5>|)> 15|}>>|<point|-1.1|1.2>>|<text-at|<math|<around*|(|S<rsub|4>
        2|)>>|<point|1.7|-0.9>>|<with|arrow-end|o|<line|<point|3.0|8.32667268468867e-17>|<point|4.0|-0.5>>>|<text-at|<math|<around*|{|<around*|(|S<rsub|3>
        S<rsub|4> S<rsub|5>|)> 7|}>>|<point|1.1|0.6>>|<text-at|<math|<around*|(|S<rsub|5>
        1|)>>|<point|3.8366|-0.9>>|<text-at|<math|<around*|{|<around*|(|S<rsub|4>
        S<rsub|5>|)> 3|}>>|<point|3.1|0.0999999999999999>>>>>|A Huffman tree
        for <math|n=5> where the relarive frequencies of the symbols are
        <math|1,2,4,\<ldots\>,2<rsup|n-1>>.>
      </float> and Figure <reference|Exercise_2.71-Figure_2><\float|float|tbh>
        <big-figure|<label|Exercise_2.71-Figure_2><with|gr-mode|<tuple|group-edit|group-ungroup>|gr-frame|<tuple|scale|1cm|<tuple|0.579992gw|0.420008gh>>|gr-geometry|<tuple|geometry|1par|0.6par>|gr-grid|<tuple|empty>|gr-grid-old|<tuple|cartesian|<point|0|0>|1>|gr-edit-grid-aspect|<tuple|<tuple|axes|none>|<tuple|1|none>|<tuple|10|none>>|gr-edit-grid|<tuple|empty>|gr-edit-grid-old|<tuple|cartesian|<point|0|0>|1>|gr-arrow-end|o|gr-auto-crop|true|<graphics||<gr-group|<text-at|<math|<around*|(|S<rsub|1>
        512|)>>|<point|-6.6|2.1>>|<with|arrow-end|o|<line|<point|-5|3>|<point|-4.0|2.5>|<point|-5.0|2.0>>>|<with|arrow-end|o|<line|<point|-5|3>|<point|-6.0|2.5>>>|<text-at|<math|<around*|(|S<rsub|2>
        256|)>>|<point|-5.5|1.6>>|<with|arrow-end|o|<line|<point|-4.0|2.5>|<point|-3.0|2.0>|<point|-4.0|1.5>>>|<text-at|<math|<around*|(|S<rsub|3>
        128|)>>|<point|-4.56034|1.1>>|<with|arrow-end|o|<line|<point|-3.0|2.0>|<point|-2.0|1.5>|<point|-3.0|1.0>>>|<text-at|<math|<around*|(|S<rsub|4>
        64|)>>|<point|-3.5|0.6>>|<with|arrow-end|o|<line|<point|-2|1.5>|<point|-1.0|1.0>|<point|-2.0|0.5>>>|<text-at|<math|<around*|(|S<rsub|5>
        32|)>>|<point|-2.5|0.1>>|<with|arrow-end|o|<line|<point|-1|1>|<point|0.0|0.5>|<point|-1.0|0.0>>>|<text-at|<math|<around*|(|S<rsub|6>
        16|)>>|<point|-1.5|-0.4>>|<with|arrow-end|o|<line|<point|0|0.5>|<point|1.0|0.0>|<point|0.0|-0.5>>>|<text-at|<math|<around*|{|<around*|(|S<rsub|1>
        S<rsub|2> S<rsub|3> S<rsub|4> S<rsub|5> S<rsub|6> S<rsub|7> S<rsub|8>
        S<rsub|9> S<rsub|10>|)> 1023|}>>|<point|-7.325992|3.185>>|<text-at|<math|<around*|(|S<rsub|7>
        8|)>>|<point|-0.4|-0.9>>|<with|arrow-end|o|<line|<point|1|0>|<point|2.0|-0.5>|<point|1.0|-1.0>>>|<text-at|<math|<around*|(|S<rsub|8>
        4|)>>|<point|0.65804|-1.4>>|<with|arrow-end|o|<line|<point|2|-0.5>|<point|3.0|-1.0>|<point|2.0|-1.5>>>|<text-at|<math|<around*|{|<around*|(|S<rsub|2>
        S<rsub|3> S<rsub|4> S<rsub|5> S<rsub|6> S<rsub|7> S<rsub|8> S<rsub|9>
        S<rsub|10>|)> 511|}>>|<point|-4.077|2.6785>>|<text-at|<math|<around*|(|S<rsub|9>
        2|)>>|<point|1.5|-1.95>>|<text-at|<math|<around*|{|<around*|(|S<rsub|3>
        S<rsub|4> S<rsub|5> S<rsub|6> S<rsub|7> S<rsub|8> S<rsub|9>
        S<rsub|10>|)> 255|}>>|<point|-3.158153|2.201822>>|<text-at|<math|<around*|{|<around*|(|S<rsub|4>
        S<rsub|5> S<rsub|6> S<rsub|7> S<rsub|8> S<rsub|9> S<rsub|10>|)>
        127|}>>|<point|-2.03848|1.674821>>|<text-at|<math|<around*|{|<around*|(|S<rsub|5>
        S<rsub|6> S<rsub|7> S<rsub|8> S<rsub|9> S<rsub|10>|)>
        63|}>>|<point|-1.0473|1.174821>>|<with|arrow-end|o|<line|<point|3|-1>|<point|4.0|-1.5>>>|<text-at|<math|<around*|{|<around*|(|S<rsub|6>
        S<rsub|7> S<rsub|8> S<rsub|9> S<rsub|10>|)>
        31|}>>|<point|-0.09113|0.710646>>|<text-at|<math|<around*|{|<around*|(|S<rsub|7>
        S<rsub|8> S<rsub|9> S<rsub|10>|)>
        15|}>>|<point|0.91932|0.15877>>|<text-at|<math|<around*|{|<around*|(|S<rsub|8>
        S<rsub|9> S<rsub|10>|)> 7|}>>|<point|2.02261873263659|-0.36681770075407>>|<text-at|<math|<around*|(|S<rsub|10>
        1|)>>|<point|3.6|-1.9>>|<text-at|<math|<around*|{|<around*|(|S<rsub|9>
        S<rsub|10>|)> 3|}>>|<point|3.0|-0.85312>>>>>|A Huffman tree for
        <math|n=10> where the relarive frequencies of the symbols are
        <math|1,2,4,\<ldots\>,2<rsup|n-1>>.>
      </float> shows the corresponding Huffman tree for <math|n=5> and
      <math|n=10> where the relarive frequencies of the symbols are
      <math|1,2,4,\<ldots\>,2<rsup|n-1>>.

      We can conclude from these trees that it takes up only 1 bit to encode
      the most frequent symbol, no matter how many symbols are contained in
      the alphabet. To encode the least frequent symbol, however, we have to
      ``go down'' the tree until we reach the designated least frequent
      symbol, which is lives in the deepest branch in the tree. Hence we are
      required to use \ <math|n-1> bits to encode it, which is the same
      amount of steps we spent in accessing the corresponding node.
    </answer>
  </render-exercise>
</body>
...
<\references>
  <\collection>
    <associate|Exercise_2.71-Figure_1|<tuple|1|?>>
    <associate|Exercise_2.71-Figure_2|<tuple|2|?>>
...
<\auxiliary>
  <\collection>
    <\associate|figure>
      <tuple|normal|A Huffman tree for <with|mode|<quote|math>|n=5> where the
      relarive frequencies of the symbols are
      <with|mode|<quote|math>|1,2,4,\<ldots\>,2<rsup|n-1>>.|<pageref|auto-1>>

      <tuple|normal|A Huffman tree for <with|mode|<quote|math>|n=10> where
      the relarive frequencies of the symbols are
      <with|mode|<quote|math>|1,2,4,\<ldots\>,2<rsup|n-1>>.|<pageref|auto-2>>
    </associate>
  </collection>
</auxiliary>