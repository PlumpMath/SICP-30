...
<\body>
  <\render-exercise|Exercise 2.86>
    ...
    will have to define operations such as <scm|sine> and <scm|cosine> that
    ...
    <\answer>
      ...
      <hspace|3ex>The operations like <scm|sine> and <scm|cosine> that are
      generic over ordinary numbers and rational numbers are define as
      follows:
      ...
      <hspace|3ex>We then add these procedures to the scheme number and
      rational packages:
