...
<\body>
  <\render-exercise|Exercise 2.88>
    ...
    <\answer>
      ...
      The plain way to performing subtraction between two polynomials is
      almost identical to that one we followed in implementing addition
      operation, except that the resulting terms list is produced by
      subtraction. Besides, we can also subtract two polys by adding the
      negation of the subtracter onto the minuend one.

      <hspace|3ex>We begin by implementing the plain strategy, just follow
      the way of addition:
      ...
      <\scm-code>
        ...
        \ \ <with|prog-font-shape|italic|\<less\>representation of poly,
        terms and term lists\<gtr\>>
        ...
        \ \ <with|prog-font-shape|italic|;; interface to rest of the system>
      ...
      <hspace|3ex>Now, let's come to erect the <scm|sub-poly> procedure by
      means of <scm|add-poly> together with a generic negation operation:
      ...
      <\scm-code>
        ...
        \ \ \<less\>representation of poly, terms and term lists\<gtr\>
      ...
      <hspace|3ex>We also have to install various negation procedures into
      Scheme-number, rational, real and complex packages:
