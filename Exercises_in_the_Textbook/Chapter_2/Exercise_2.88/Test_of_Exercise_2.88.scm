...
(neg (make-rational 0 8))
;Value 20: (rational 0 . 1)

(neg (make-rational -3 8))
;Value 21: (rational 3 . 8)

(neg (make-complex-from-real-imag 0 0))
;Value 36: (complex rectangular 0 . 0)

(neg (make-complex-from-mag-ang 3 -4))
;Value 37: (complex polar -3 . 4)

(neg (make-polynomial 'x '((4 1) (3 -2) (2 -2) (0 6))))
;Value 38: (polynomial x (4 -1) (3 2) (2 2) (0 -6))

(sub (make-polynomial 'x '((4 1) (3 -2) (2 -2) (0 6)))
     (make-polynomial 'y '((4 1) (3 -2) (2 -2) (0 6))))
...
(sub (make-polynomial 'x '((4 1) (3 -2) (2 -2) (0 6)))
     (make-polynomial 'x '((4 1) (3 -2) (2 -2) (0 6))))
;Value 39: (polynomial x)

(sub (make-polynomial 'x '((4 1) (3 8) (2 -2) (0 6)))
     (make-polynomial 'x '((4 3) (3 -2) (2 -2) (1 5) (0 6))))
;Value 40: (polynomial x (4 -2) (3 10) (1 -5))
