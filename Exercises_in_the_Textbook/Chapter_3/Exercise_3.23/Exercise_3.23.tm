...
<\body>
  <\render-exercise|Exercise 3.23>
    ...
    distined to disillusion us. Notice that in the ordinary list, which
    serves as the foundation to our queue representation, one can only access
    the precursor of the last item by successive <scm|cdr> operation. This
