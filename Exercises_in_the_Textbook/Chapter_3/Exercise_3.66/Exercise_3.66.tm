...
<\body>
  <\render-exercise|Exercise 3.66>
    ...
    aka <with|font|heiti|\<#989C\> \<#5E8F\>>). This answer is inspired by
    the one posted by Yin Wang at: http://docs.huihoo.com/homepage/shredderyin/src/exercises.ps.
    Special thanks are due to Yin.<new-line> <hspace|2.20ex>Email address:
    informlarry@gmail.com>

    Examine the stream <scm|(pairs integers integers)>. Can you make any
    general comments about the order in which the pairs are placed into the
    stream? For example, about how many pairs precede the pair
    <math|(1,100)>? the pair <math|(99,100)>? the pair <math|(100,100)>? (If
    you can make precise mathematical statements here, all the better. But
    ...
    <\answer>
      ...
      We denote an arbitrary upper triangular block in <scm|(pairs S T)> by
      <math|P<rsub|n>>, and consider it to be composed of three parts: the
      pair <math|<around*|(|S<rsub|n>,T<rsub|n>|)>>, the rest of the pairs in
      its first row (denoted by <math|R<rsub|n>>), and the remaining pairs
      (denoted by another block <math|P<rsub|n+1>>), as figure
      <reference|Exercise_3.66-Figure_1><\float|float|tbh>
        <big-figure|<label|Exercise_3.66-Figure_1><with|gr-mode|<tuple|edit|line>|gr-frame|<tuple|scale|1cm|<tuple|0.470003gw|0.5gh>>|gr-geometry|<tuple|geometry|1par|0.6par>|gr-grid|<tuple|empty>|gr-grid-old|<tuple|cartesian|<point|0|0>|1>|gr-edit-grid-aspect|<tuple|<tuple|axes|none>|<tuple|1|none>|<tuple|10|none>>|gr-edit-grid|<tuple|empty>|gr-edit-grid-old|<tuple|cartesian|<point|0|0>|1>|gr-color|magenta|gr-dash-style|10|gr-auto-crop|true|<graphics||<text-at|<tabular|<tformat|<cwith|6|8|6|6|cell-bborder|0>|<cwith|4|4|4|9|cell-halign|c>|<cwith|9|9|7|9|cell-halign|c>|<cwith|6|9|6|6|cell-lborder|0.2mm>|<cwith|4|4|8|10|cell-halign|c>|<cwith|8|8|8|8|cell-halign|c>|<cwith|6|6|5|10|cell-bborder|0.2mm>|<cwith|6|6|6|10|cell-background|>|<table|<row|<cell|<math|<around*|(|S<rsub|0>,T<rsub|0>|)>>>|<cell|<math|<around*|(|S<rsub|0>,T<rsub|1>|)>>>|<cell|<math|\<ldots\>>>|<cell|<math|<around*|(|S<rsub|0>,T<rsub|n-1>|)>>>|<cell|<math|<around*|(|S<rsub|0>,T<rsub|n>|)>>>|<cell|<math|<around*|(|S<rsub|0>,T<rsub|n+1>|)>>>|<cell|<math|<around*|(|S<rsub|0>,T<rsub|n+2>|)>>>|<cell|<math|\<ldots\>>>|<cell|<math|<around*|(|S<rsub|0>,T<rsub|m>|)>>>|<cell|<math|\<ldots\>>>>|<row|<cell|>|<cell|<math|<around*|(|S<rsub|1>,T<rsub|1>|)>>>|<cell|<math|\<ldots\>>>|<cell|<math|<around*|(|S<rsub|1>,T<rsub|n-1>|)>>>|<cell|<math|<around*|(|S<rsub|1>,T<rsub|n>|)>>>|<cell|<math|<around*|(|S<rsub|1>,T<rsub|n+1>|)>>>|<cell|<math|<around*|(|S<rsub|0>,T<rsub|n+2>|)>>>|<cell|<math|\<ldots\>>>|<cell|<math|<around*|(|S<rsub|1>,T<rsub|m>|)>>>|<cell|<math|\<ldots\>>>>|<row|<cell|>|<cell|>|<cell|<math|\<ldots\>>>|<cell|<math|<around*|(|S<rsub|2>,T<rsub|n-1>|)>>>|<cell|<math|<around*|(|S<rsub|2>,T<rsub|n>|)>>>|<cell|<math|<around*|(|S<rsub|2>,T<rsub|n+1>|)>>>|<cell|<math|<around*|(|S<rsub|0>,T<rsub|n+2>|)>>>|<cell|<math|\<ldots\>>>|<cell|<math|<around*|(|S<rsub|2>,T<rsub|m>|)>>>|<cell|<math|\<ldots\>>>>|<row|<cell|>|<cell|>|<cell|<math|\<ddots\>>>|<cell|<math|\<vdots\>>>|<cell|<math|\<vdots\>>>|<cell|<math|\<vdots\>>>|<cell|<math|\<vdots\>>>|<cell|<math|\<vdots\>>>|<cell|<math|\<vdots\>>>|<cell|<math|\<vdots\>>>>|<row|<cell|>|<cell|>|<cell|>|<cell|<math|<around*|(|S<rsub|n-1>,T<rsub|n-1>|)>>>|<cell|<math|<around*|(|S<rsub|n-1>,T<rsub|n>|)>>>|<cell|<math|<around*|(|S<rsub|n-1>,T<rsub|n+1>|)>>>|<cell|<math|<around*|(|S<rsub|n-1>,T<rsub|n+2>|)>>>|<cell|<math|\<ldots\>>>|<cell|<math|<around*|(|S<rsub|n-1>,T<rsub|m>|)>>>|<cell|<math|\<ldots\>>>>|<row|<cell|>|<cell|>|<cell|>|<cell|>|<cell|<math|<around*|(|S<rsub|n>,T<rsub|n>|)>>>|<cell|<math|<around*|(|S<rsub|n>,T<rsub|n+1>|)>>>|<cell|<math|<around*|(|S<rsub|n>,T<rsub|n+2>|)>>>|<cell|<math|\<ldots\>>>|<cell|<math|<around*|(|S<rsub|n>,T<rsub|m>|)>>>|<cell|...>>|<row|<cell|>|<cell|>|<cell|>|<cell|>|<cell|>|<cell|<math|<around*|(|S<rsub|n+1>,T<rsub|n+1>|)>>>|<cell|<math|<around*|(|S<rsub|n+1>,T<rsub|n+2>|)>>>|<cell|<math|\<ldots\>>>|<cell|<math|<around*|(|S<rsub|n+1>,T<rsub|m>|)>>>|<cell|<math|\<ldots\>>>>|<row|<cell|>|<cell|>|<cell|>|<cell|>|<cell|>|<cell|>|<cell|<math|<around*|(|S<rsub|n+2>,T<rsub|n+2>|)>>>|<cell|<math|\<ldots\>>>|<cell|<math|<around*|(|S<rsub|n+2>,T<rsub|m>|)>>>|<cell|<math|\<ldots\>>>>|<row|<cell|>|<cell|>|<cell|>|<cell|>|<cell|>|<cell|>|<cell|>|<cell|<math|\<ddots\>>>|<cell|<math|\<ldots\>>>|<cell|<math|\<ldots\>>>>>>>|<point|-6.78609935176611|-0.338645984918639>>|<with|color|dark
        green|<cline|<point|0.112135|-0.916705>|<point|6.77968315914804|-0.895538431009393>|<point|6.77968315914804|-2.03854676544516>|<point|0.0909677205979627|-2.03854676544516>>>|<with|color|red|<cline|<point|-1.91988027516867|-0.408701547823786>|<point|7.0|-0.4>|<point|7.0|-2.2>|<point|-1.91988027516867|-2.20788133350972>>>|<with|color|dark
        green|<text-at|<math|P<rsub|n+1>>|<point|0.302636|-1.80571>>>|<with|color|red|<text-at|<math|P<rsub|n>>|<point|-1.72022|-2.01738>>>|<with|color|magenta|dash-style|10|<cline|<point|0.100129|-0.514536>|<point|6.74651078184945|-0.514535652864136>|<point|6.74651078184945|-0.810871146977113>|<point|0.100128985315518|-0.810871146977113>>>|<with|color|magenta|<text-at|<math|R<rsub|n>>|<point|5.98451|-0.705037>>>>>|The
        geometry interpretation of stream <scm|(pairs S T)>.>
      </float> shows.<new-line> <hspace|2ex>Our problem, then, is to figure
      out the order in which <math|<around*|(|S<rsub|n>,T<rsub|m>|)>> is
      placed into the stream. In other words, we have to calculate the amount
      of pairs in total preceding to <math|<around*|(|S<rsub|n>,T<rsub|m>|)>>
      inside block <math|P<rsub|0>>. Since blocks are nested one by another,
      we can pick up an arbitrary block <math|P<rsub|n>> and calculate the
      amount of pairs preceding to <math|<around*|(|S<rsub|n>,T<rsub|m>|)>>
      inside that block. Using this result, we can eventually figure out the
      amount of pairs in total preceding to
      <math|<around*|(|S<rsub|n>,T<rsub|k>|)>> inside block <math|P<rsub|0>>
      by iteration.<new-line> <hspace|2ex>In terms of block <math|P<rsub|n>>,
      we will have to enumerate <math|m-n-1> pairs:
      <math|<around*|(|S<rsub|n>,T<rsub|n+1>|)>,<around*|(|S<rsub|n>,T<rsub|n+2>|)>,\<ldots\>,<around*|(|S<rsub|n>,T<rsub|m-1>|)>>
      in stream <math|R<rsub|n>> before <math|<around*|(|S<rsub|n>,T<rsub|m>|)>>
      is reached. Besides, according to <scm|interleave>, which takes
      elements alternately from <math|R<rsub|n>> and <math|P<rsub|n+1>>, an
      additional <math|m-n-1> pairs inside the block <math|P<rsub|n+1>> also
      need to be enumerated. Together with the pair
      <math|<around*|(|S<rsub|n>,T<rsub|n>|)>>, we will have to enumerate
      <math|2*<around*|(|m-n-1|)>+1> pairs in total in block
      <math|P<rsub|n>>, denoted by <math|A<rsub|n>>.<new-line>
      <hspace|2ex>Likewise, an additional <math|A<rsub|n>> pairs need to be
      enumerated in stream <math|R<rsub|n-1>>, which lies above
      <math|P<rsub|n>>. So we have to enumerate <math|2*A<rsub|n>+1> pairs in
      <math|P<rsub|n-1>>, the block that embraces <math|P<rsub|n>>, denoted
      by <math|A<rsub|n-1>>. We can follow this pattern to compute the amount
      of enumetation iteratively until we extend the block to
      <math|P<rsub|0>>:

      <\eqnarray*>
        <tformat|<table|<row|<cell|A<rsub|n>>|<cell|=>|<cell|2*<around*|(|m-n-1|)>+1>>|<row|<cell|A<rsub|n-1>>|<cell|=>|<cell|2*A<rsub|n>+1>>|<row|<cell|\<ldots\>>|<cell|>|<cell|\<ldots\>>>|<row|<cell|A<rsub|0>>|<cell|=>|<cell|2*A<rsub|1>+1>>>>
      </eqnarray*>

      Now we can calculate the value of <math|A<rsub|0>> by iteration:

      <\eqnarray*>
        <tformat|<table|<row|<cell|A<rsub|0>>|<cell|=>|<cell|2*A<rsub|1>+1>>|<row|<cell|>|<cell|=>|<cell|2*<around*|(|2*A<rsub|2>+1|)>+1>>|<row|<cell|>|<cell|=>|<cell|2<rsup|2>*A<rsub|2>+2+1>>|<row|<cell|>|<cell|=>|<cell|2<rsup|2>*<around*|(|2*A<rsub|3>+1|)>+2+1>>|<row|<cell|>|<cell|=>|<cell|2<rsup|3>*A<rsub|3>+2<rsup|2>+2+1>>|<row|<cell|>|<cell|=>|<cell|\<ldots\>>>|<row|<cell|>|<cell|=>|<cell|2<rsup|n>*A<rsub|n>+2<rsup|n-1>+2<rsup|n-2>+\<ldots\>+2+1>>|<row|<cell|>|<cell|=>|<cell|2<rsup|n>*<around*|[|2*<around*|(|m-n-1|)>+1|]>+<frac|1\<times\><around*|(|1-2<rsup|n>|)>|1-2>>>|<row|<cell|>|<cell|=>|<cell|2<rsup|n+1>*<around*|(|m-n|)>-2<rsup|n+1>+2<rsup|n>-<around*|(|1-2<rsup|n>|)>>>|<row|<cell|>|<cell|=>|<cell|2<rsup|n+1>*<around*|(|m-n|)>-2<rsup|n+1>+2<rsup|n>-1+2<rsup|n>>>|<row|<cell|>|<cell|=>|<cell|2<rsup|n+1>*<around*|(|m-n|)>-2<rsup|n+1>+2\<times\>2<rsup|n>-1>>|<row|<cell|>|<cell|=>|<cell|2<rsup|n+1>*<around*|(|m-n|)>-2<rsup|n+1>+2<rsup|n+1>-1>>|<row|<cell|>|<cell|=>|<cell|2<rsup|n+1>*<around*|(|m-n|)>-1>>>>
      </eqnarray*>

      <hspace|3ex>So, we will have to enumerate an amount of
      <math|2<rsup|n+1>*<around*|(|m-n|)>-1> pairs before
      <math|<around*|(|S<rsub|n>,T<rsub|m>|)>> is reached. In other words,
      the pair <math|<around*|(|S<rsub|n>,T<rsub|m>|)>> is placed under the
      order of <math|2<rsup|n+1>*<around*|(|m-n|)>> in the stream.
    </answer>
  </render-exercise>
</body>
...
<\references>
  <\collection>
    <associate|Exercise_3.66-Figure_1|<tuple|1|2>>
...
<\auxiliary>
  <\collection>
    <\associate|figure>
      <tuple|normal|The geometry interpretation of stream
      <with|mode|<quote|prog>|prog-language|<quote|scheme>|font-family|<quote|rm>|(pairs
      S T)>.|<pageref|auto-1>>
    </associate>
  </collection>
</auxiliary>